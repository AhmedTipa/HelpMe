                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          TextButton(
                            onPressed: (){
                              cubit.technicalGetServicesData(
                          ...
                          SizedBox(
                            ...
                            child: ConditionalBuilder(
                              condition: state
                                  is! TechnicalGetServicesDataLoadingState,
                              builder: (context) => listView(cubit),
                              fallback: (context) =>
...
Widget listView(TechnicalCubit cubit) => ListView.separated(
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  Text(
                    '${cubit.technicalServicesModel!.services![index].title}',
                    style: const TextStyle(
                      fontSize: 16,
                      fontWeight: FontWeight.w400,
                  ...
                  Text(
                    '${cubit.technicalServicesModel!.services![index].description}',
                    style: const TextStyle(
                      fontSize: 7,
                      fontWeight: FontWeight.w400,
                      color: Color(0xff393F42),
            ...
            Column(
              ...
              children: [
                Text(
                  '${cubit.technicalServicesModel!.services![index].price} ج.م/ساعه',
                  style: const TextStyle(
                    fontSize: 10,
                    fontWeight: FontWeight.w400,
                    color: Color(0xff393F42),
      ...
      itemCount: cubit.technicalServicesModel!.services!.length,
    );
